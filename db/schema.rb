...
ActiveRecord::Schema.define(version: 20151016212112) do
  ...
  add_index "items", ["member_id"], name: "index_items_on_member_id", using: :btree
  ...
  add_index "teams", ["member_id"], name: "index_teams_on_member_id", using: :btree
