...
ActiveRecord::Schema.define(version: 20151018234623) do
  ...
  add_index "follows", ["target_id", "user_id"], name: "index_follows_on_target_id_and_user_id", unique: true, using: :btree
